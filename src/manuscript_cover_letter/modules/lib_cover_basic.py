...
def generate_cover_basic1( filename, dict_info ):
    ...
    generate_cover_basic1_raw(  dict_info["title"],
                                dict_info["journal"],
...
def generate_cover_basic1_raw(  title,
                                journal,
                                complete_name,
                                university,
                                country,
    ...
    add_paragraph(
        doc,
        f"I hereby notify that the submitted paper is original and is not under consideration by any other journal at the time of submission, and the essential scientific results will not be submitted to another journal while the paper is under consideration for publication in {journal}.",
        align=WD_PARAGRAPH_ALIGNMENT.JUSTIFY
    )
    ...
    add_paragraph(doc, complete_name + "\n" + university)
...
if __name__ == '__main__':
    ...
    generate_cover_basic1_raw(  title,
                                journal,
                                complete_name,
                                university,
                                country,
